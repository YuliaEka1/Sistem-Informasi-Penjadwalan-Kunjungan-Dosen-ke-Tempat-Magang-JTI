    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item {{ isActiveManajData() ? 'menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @if(Auth::user()->role == 'dosen')
                                <li class="nav-item">
                                    <a href="{{ url('/dataDosen2') }}" class="nav-link {{ Request::is('dataDosen2') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Data Dosen</p>
                                    </a>
                                </li>
                            ...
                            @if(Auth::user()->role == 'mahasiswa')
                                <li class="nav-item">
                                    <a href="{{ url('/dataMahasiswa2') }}" class="nav-link {{ Request::is('dataMahasiswa2') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Data Mahasiswa</p>
                                    </a>
                                </li>
                            ...
                            @if(Auth::user()->role == 'dosen')
                                <li class="nav-item">
                                    <a href="{{ url('/dtMahasiswa') }}" class="nav-link {{ Request::is('dtMahasiswa') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Data Mahasiswa</p>
                                    </a>
                                </li>
                ...
                <!-- Konfirmasi Industri Menu -->
                @if(Auth::user()->role == 'industri')
                    <li class="nav-item {{ isActiveKonfirmasiIndustri() ? 'menu-open' : '' }}">
                        <a href="javascript:void(0);" class="nav-link {{ isActiveKonfirmasiIndustri() ? 'active' : '' }}">
